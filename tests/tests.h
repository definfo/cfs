...
#define TEST(__function_name__, __use__)                                      \
        ...
        {                                                                     \
                const char *__test_id                                         \
                    = _FS_TESTS_STRINGIFY (__function_name__.__use__);        \
                                                                              \
                clock_t start;                                                \
                clock_t end;                                                  \
                int elapsed;                                                  \
...
#define REGISTER_TEST(__function_name__, __use__)                             \
        _add_test (_FS_TESTS_STRINGIFY (__function_name__),                   \
                   _##__function_name__##_##__use__##_test)
...
RUN_ALL_TESTS (void)
{
        ...
        for (i = 0; i < __tests_count; ++i)
                {
                        ...
                        tend = clock ();
                        elapsed
                            = (int)((tend - tstart) * 1000.0 / CLOCKS_PER_SEC);
        ...
        printf (_FS_TESTS_MAKE_GREEN (
                    "[==========]") " %d test%s from %d test case%s ran. (%d "
                                    "ms total)\n",
...
extern void
_add_test (const char *name, int (*cb) (void))
{
        int i;
